...
class SearchLocators:
    """Локаторы для тестов по поиску в Яндексе"""
    SEARCH_FIELD = (By.ID, 'text')
    SUGGEST = (By.CSS_SELECTOR,
               '[class="mini-suggest__overlay mini-suggest__overlay_theme-color_dark mini-suggest__overlay_visible"]')
    LINKS = (By.CSS_SELECTOR, '[class="Link Link_theme_normal OrganicTitle-Link organic__url link"]')


class ImagesLocators:
    """Локаторы для тестов по картинкам в Яндексе"""
